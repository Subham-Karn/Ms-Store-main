...
import { googleOAuth, signUpUser } from "../../store/slices/userSlice.js";
...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.email || !formData.password) {
      return toast.error("Please fill in all input credentials requirements");
    }
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md  p-8 ">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-gray-500 mt-2">Join to compile automated digital invoices and secure fast trading</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Secure Password</label>
            <div className="relative">
        ...
        <div className="relative my-6 flex items-center justify-center">
          ...
          <span className="relative bg-white px-3 text-xs text-gray-400 uppercase tracking-widest font-medium">Or</span>
        </div>
        ...
        <p className="text-xs text-center text-gray-500 mt-6">
          Already have a collection profile?{" "}
          <Link to="/login" className="text-[#1a5a8a] hover:underline font-bold">Log In</Link>
        </p>
